...
# ====================== КЛАВИАТУРЫ ======================
def day_keyboard():
    """Клавиатура выбора дня недели выхода нового эпизода"""
    days = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"]
    buttons = [
        [types.InlineKeyboardButton(text=day, callback_data=f"day_{i}")]
...
async def process_day(callback: types.CallbackQuery, state: FSMContext):
    """Обработка выбора дня недели выхода нового эпизода"""
...
# ====================== ОТМЕТКА ПРОСМОТРЕННЫХ ЭПИЗОДОВ И СЕЗОНОВ ======================
